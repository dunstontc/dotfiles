  ...
  (setq-default
    ...
    dotspacemacs-additional-packages '(
                                        ...
                                        ;; all-the-icons-dired
                                        ;; Custom
                                        ;; (all-the-icons :location (recipe :fetcher github
                                                                         ;; :repo "dunstontc/all-the-icons.el"))
  ...
  ;; ----------------------------------------------------------------
  ;; Make sure Spacemacs greets us kindly
  (setq exec-path-from-shell-check-startup-files nil)
  ;; Fix issue with powerline separators
  (setq powerline-image-apple-rgb t)
  ;; Assignments
  ;; (setq org-agenda-files (list "~/org/spacemax.org"))
  ;; ----------------------------------------------------------------
  )
  ...
  ;; ----------------------------------------------------------------
    ...
    ;; Make that tree a little more sexy
    ...
    ;; Delete under the cursor in normal mode
    (define-key evil-normal-state-map (kbd "DEL") 'delete-forward-char)
    ...
    ;; Use S-h & S-L to go to the Beginning & End of lines
    (define-key evil-normal-state-map (kbd "H") (kbd "^"))
    (define-key evil-normal-state-map (kbd "L") (kbd "$"))

    ;; Toggle Comments
    (define-key evil-normal-state-map (kbd "H-/") 'evilnc-comment-or-uncomment-lines)
    (define-key evil-insert-state-map (kbd "H-/") 'evilnc-comment-or-uncomment-lines)
    (define-key evil-normal-state-map (kbd ",/") 'evilnc-comment-or-uncomment-lines)
    (define-key evil-insert-state-map (kbd ",/") 'evilnc-comment-or-uncomment-lines)
    ...
    (add-to-list 'auto-mode-alist '("\\.fzf$" . sh-mode))
    (add-to-list 'auto-mode-alist '("\\.highlight$" . sh-mode))
    (add-to-list 'auto-mode-alist '("\\.path$" . sh-mode))
    (add-to-list 'auto-mode-alist '("\\.profile$" . sh-mode))
    (add-to-list 'auto-mode-alist '("Brewfile$" . sh-mode))
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (darkplus-theme yaml-mode zenburn-theme zen-and-art-theme underwater-theme ujelly-theme twilight-theme twilight-bright-theme twilight-anti-bright-theme toxi-theme tao-theme tangotango-theme tango-plus-theme tango-2-theme sunny-day-theme sublime-themes subatomic256-theme subatomic-theme spacegray-theme soothe-theme solarized-theme soft-stone-theme soft-morning-theme soft-charcoal-theme smyx-theme seti-theme reverse-theme railscasts-theme purple-haze-theme professional-theme planet-theme phoenix-dark-pink-theme phoenix-dark-mono-theme organic-green-theme omtose-phellack-theme oldlace-theme occidental-theme obsidian-theme noctilux-theme naquadah-theme mustang-theme monokai-theme monochrome-theme molokai-theme moe-theme minimal-theme material-theme majapahit-theme madhat2r-theme lush-theme light-soap-theme jbeans-theme jazz-theme ir-black-theme inkpot-theme heroku-theme hemisu-theme hc-zenburn-theme gruvbox-theme gruber-darker-theme grandshell-theme gotham-theme gandalf-theme flatui-theme flatland-theme farmhouse-theme espresso-theme dracula-theme django-theme darktooth-theme autothemer darkokai-theme darkmine-theme darkburn-theme dakrone-theme cyberpunk-theme color-theme-sanityinc-tomorrow color-theme-sanityinc-solarized clues-theme cherry-blossom-theme busybee-theme bubbleberry-theme birds-of-paradise-plus-theme badwolf-theme apropospriate-theme anti-zenburn-theme ample-zen-theme ample-theme alect-themes afternoon-theme reveal-in-osx-finder pbcopy osx-trash osx-dictionary launchctl helm-company helm-c-yasnippet company-statistics auto-yasnippet ac-ispell fuzzy company yasnippet auto-complete ws-butler winum which-key volatile-highlights vi-tilde-fringe uuidgen use-package toc-org spaceline powerline restart-emacs request rainbow-delimiters popwin persp-mode pcre2el paradox spinner org-bullets open-junk-file neotree move-text macrostep lorem-ipsum linum-relative link-hint info+ indent-guide hydra hungry-delete hl-todo highlight-parentheses highlight-numbers parent-mode highlight-indentation hide-comnt help-fns+ helm-themes helm-swoop helm-projectile helm-mode-manager helm-make projectile pkg-info epl helm-flx helm-descbinds helm-ag google-translate golden-ratio flx-ido flx fill-column-indicator fancy-battery eyebrowse expand-region exec-path-from-shell evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-surround evil-search-highlight-persist evil-numbers evil-nerd-commenter evil-mc evil-matchit evil-lisp-state smartparens evil-indent-plus evil-iedit-state iedit evil-exchange evil-escape evil-ediff evil-args evil-anzu anzu evil goto-chg undo-tree eval-sexp-fu highlight elisp-slime-nav dumb-jump f dash s diminish define-word column-enforce-mode clean-aindent-mode bind-map bind-key auto-highlight-symbol auto-compile packed aggressive-indent adaptive-wrap ace-window ace-link ace-jump-helm-line helm avy helm-core popup async org-plus-contrib)))
