" " ===============================================================
" "   === VimDarkPlus ===
" " Transmuted from Mike Hartington's OceanicNext Theme (https://github.com/mhartington/oceanic-next)
" " ===============================================================
" " +-----------------------------------------------------------------+
" " |  Color Name     |         RGB        |   Hex   | Xterm          |
" " |-----------------+--------------------+---------+----------------|
" " | very_dark_gray  | rgb(30, 30, 30)    | #1e1e1e | 234 (#1c1c1c)  |
" " |-----------------+--------------------+---------+----------------|
" " | (dark)atom_gray | rgb(40, 44, 52)    | #282c34 | 235 (#262626)  |
" " |-----------------+--------------------+---------+----------------|
" " | light_gray      | rgb(128, 128, 128) | #808080 | 244 (#808080)  |
" " |-----------------+--------------------+---------+----------------|
" " | very_light_gray | rgb(212, 212, 212) | #d4d4d4 | 253 (#dadada)  |
" " |-----------------+--------------------+---------+----------------|
" " | light_red       | rgb(209, 105, 105) | #d16969 | 210 (#ff8787)  |
" " |-----------------+--------------------+---------+----------------|
" " | dark_red        | rgb(244, 71, 71)   | #f44747 | 196 (#ff0000)  |
" " |-----------------+--------------------+---------+----------------|
" " | orange          | rgb(206, 145, 120) | #ce9178 | 216 (#ffaf87)  |
" " |-----------------+--------------------+---------+----------------|
" " | light_yellow    | rgb(220, 220, 170) | #dcdcaa | 229 (#ffffaf)  |
" " |-----------------+--------------------+---------+----------------|
" " | dark_yellow     | rgb(215, 186, 125) | #d7ba7d | 179 (#d7af5f)  |
" " |-----------------+--------------------+---------+----------------|
" " | light_green     | rgb(181, 206, 168) | #b5cea8 | 108 (#87af87)  |
" " |-----------------+--------------------+---------+----------------|
" " | dark_green      | rgb(96, 139, 78)   | #608b4e | 65  (#5f875f)  |
" " |-----------------+--------------------+---------+----------------|
" " | teal            | rgb(78, 201, 176)  | #4ec9b0 | 79  (#00d7af)  |
" " |-----------------+--------------------+---------+----------------|
" " | light_blue      | rgb(156, 220, 254) | #9cdcfe | 117 (#87d7ff)  |
" " |-----------------+--------------------+---------+----------------|
" " | dark_blue       | rgb(86, 156, 214)  | #569cd6 | 75  (#5fafff)  |
" " |-----------------+--------------------+---------+----------------|
" " | bright_blue     | rgb(0, 122, 204)   | #007acc | 33  (#0087ff)  |
" " |-----------------+--------------------+---------+----------------|
" " | pink            | rgb(197, 134, 192) | #c586c0 | 176 (#d787d7)  |
" " +-----------------------------------------------------------------+
" " {{{ Setup
"   set background=dark
"   hi clear
...
"     syntax reset
"   endif
"   let g:colors_name="VimDarkPlus"
" " }}}
" " {{{ Italics
"   let g:dark_plus_terminal_italic = get(g:, 'dark_plus_terminal_italic', 0)
"   let s:italic = ""
"   if g:dark_plus_terminal_italic == 1
"     let s:italic = "italic"
"   endif
" "}}}
" " {{{ Bold
"   let g:dark_plus_terminal_bold = get(g:, 'dark_plus_terminal_bold', 0)
"   let s:bold = ""
"   if g:dark_plus_terminal_bold == 1
"    let s:bold = "bold"
"   endif
" "}}}
" " " {{{ Colors
