...
" Punctuation {{{2
syn match     rustPunctuation ";"
syn match     rustDot         "^\s\+\."
syn match     rustDot         "\."

" Basic keywords {{{2
syn keyword   rustConditional     match if else
syn keyword   rustRepeat          for loop while in
...
syn keyword   rustControlKeyword break continue return yield
...
syn keyword   rustStorage     impl let move mut ref static const
...
syn region    rustString      start=+"+ skip=+\\\\\|\\"+ end=+"+ contains=rustEscape,rustEscapeUnicode,rustEscapeError,rustStringContinuation,@Spell,rustPlaceholder
syn region    rustString      start='b\?r\z(#*\)"' end='"\z1' contains=@Spell

syn match     rustPlaceholder "{}" contained
