"""FZF as a matcher for denite."""
# ============================================================================
# FILE:    matcher_fzf.py
# AUTHOR:  Shougo Matsushita <Shougo.Matsu at gmail.com>
# License: MIT license
# NOTE:    I'm not sure what the deal is with this file... the license & repo belong to 'blankname' so...
# ORIGIN:  https://github.com/blankname/denite_fzf_matcher/blob/master/rplugin/python3/denite/filter/matcher_fzf.py
# ============================================================================
