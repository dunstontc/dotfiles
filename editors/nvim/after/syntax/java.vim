...
" Current URL:		https://github.com/dunstontc/nvim.d
" Previous Maintainer:	kamichidu <c.kamunagi@gmail.com>
...
if !exists("main_syntax")
  ...
  let g:java_highlight_java=0
  let g:java_highlight_java_lang=0
  let g:java_highlight_java_lang_ids=0
...
syn keyword javaThis		super
syn keyword javaSuper		this
...
if exists("java_highlight_functions") " {{{
  if java_highlight_functions == "indent"
    ...
    " This line catches method declarations at any indentation>0,
...
if version >= 508 || !exists("did_java_syn_inits")
  ...
  JavaHiLink javaBraces			Delimiter
