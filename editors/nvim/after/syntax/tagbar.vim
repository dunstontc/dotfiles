...
" syntax region TagbarSignature  start="(" end=")"
" syntax match TagbarSignature  '(.*)'
" syntax match TagbarPseudoID   '\*\ze :'
" }}}

syntax match TagbarParens	"(\|)" contained containedin=ALL
syntax match TagbarFunc		"\(\s\|-\|+\)w\+\(()\)\@=" contained containedin=ALL
syntax keyword TagbarSection	functions	variables	imports	package

" Links: {{{
highlight default link TagbarParens     Delimiter
highlight default link TagbarSection    Title
highlight default link TagbarFunc       Function
" highlight default link Tagbar       Comment
